...
// like a constructor, initialize loggingMiddleware with value
// now the middleware is linked to service
...
func (mw loggingMiddleware) HealthCheck() (result bool) {
	// call this function after health check
	// delay the execution of the function until the nearby functions returns
